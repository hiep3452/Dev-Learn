const PaymentPage = () => {
    ...
    return (
        <div
            ...
            style={{
                backgroundImage:
                    "url('https://get.wallhere.com/photo/programming-language-technology-tilt-shift-computer-1937215.jpg')",
            }}
        >
            <div className="bg-white rounded-lg shadow-md p-6 w-96 text-center">
                ...
                >
                    Are you accepted to become a super member at DevLearn Blog?
                </button>
            </div>
        </div>
    );

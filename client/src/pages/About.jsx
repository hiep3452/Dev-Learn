            ...
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
                    <div>
                        ...
                        >
                            Welcome to DevLearn – Your Gateway to the World of
                            Technology
                ...
                >
                  Postcrafts.
                        ...
                        <p
                            className={`mt-8 text-base sm:text-xl ${
                                theme === "dark"
                                    ? "text-gray-300"
                                    : "text-black"
                            }`}
                        >
                            Our mission is to create a platform where technology
                            enthusiasts can connect, collaborate, and share
                            their knowledge. We aim to foster a community where
                            learning is continuous, and innovation is at the
                            forefront.
                        </p>
